...
Гайд собирался руками: чтение протокола, проверка каждой ручки, сверка с тем, что реально отвечает сервер. Если он сэкономил тебе время, можно закинуть на кофе.
